...
export class BankDetailsDeleteDialog extends React.Component<IBankDetailsDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.bankDetailsEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="accounTalkApp.bankDetails.delete.question">
          <Translate contentKey="accounTalkApp.bankDetails.delete.question" interpolate={{ id: bankDetailsEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-bankDetails" color="danger" onClick={this.confirmDelete}>
